...
- **`docs/INSTRUCTOR_ANSWER_OUTLINE.md`** — **講師專用**評分索引與檢核表；逐課大綱見 **`docs/instructor/`**（[`docs/instructor/README.md`](docs/instructor/README.md)）。
...
- [docs/INSTRUCTOR_ANSWER_OUTLINE.md](docs/INSTRUCTOR_ANSWER_OUTLINE.md) — 講師評分索引與檢核表
- [docs/instructor/README.md](docs/instructor/README.md) — 逐課講師大綱（lab00–lab15）
